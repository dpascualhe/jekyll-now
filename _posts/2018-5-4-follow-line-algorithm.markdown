...
| **Situations**                                | **Actions**                                             |
| --------------------------------------------- | ------------------------------------------------------- |
| &npsp;Turn                             &npsp; | &npsp;v = 6;    w = PD controller(kp=2, kd=3.5)  &npsp; |
| &npsp;Straight line during > 10 frames &npsp; | &npsp;v = 20;   w = PD controller(kp=0.25, kd=3) &npsp; |
| &npsp;Straight line during < 10 frames &npsp; | &npsp;v = 6;    w = PD controller(kp=0.25, kd=3) &npsp; |
| &npsp;No line                          &npsp; | &npsp;v = 0.25; w = 0.25                         &npsp; | 
{: .tablelines}
